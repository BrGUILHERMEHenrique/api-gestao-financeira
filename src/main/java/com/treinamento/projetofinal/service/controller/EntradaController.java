...
public class EntradaController {
	...
	public ResponseEntity<Entrada> retornaPorId(@PathVariable Long id) throws EntradaNaoEncontradaException {
		return ResponseEntity.ok(entradaService.retornaPorId(id));
	}
	
	@PostMapping("/criar")
	public ResponseEntity<Entrada> criaNovaEntrada(@RequestBody EntradaDto dto) throws UsuarioNaoEncontradoException {
		return ResponseEntity.ok(entradaService.adicionarEntrada(dto));
	}
	
	@PutMapping("/atualizar/{id}")
	public ResponseEntity<String> atualizarDescricaoEntrada(@PathVariable Long id, @RequestBody EntradaDto dto) throws EntradaNaoEncontradaException {
		return ResponseEntity.ok(entradaService.atualizarEntrada(id, dto));
	}
	
	@DeleteMapping("/apagar/{id}")
	public ResponseEntity<String> apagaUmaEntrada(@PathVariable Long id) throws EntradaNaoEncontradaException {
